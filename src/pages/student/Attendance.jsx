...
export default function StudentAttendanceView() {
  ...
  // Block navigating before the student's admission/caseHistoryDate month
  const startRaw = userData?.caseHistoryDate || userData?.admissionDate
      ...
      <div>
        ...
        {startDate && (
          <p className="text-xs text-gray-400 mt-1">
            ...
            <span className="font-medium text-gray-500">{format(startDate, 'MMMM yyyy')}</span>
          </p>
        )}
      </div>
